...
function PricingComponent() {
  ...
  return (
    <div className='container mx-auto my-24 font-[Outfit]'>
      ...
      {/* Pricing Cards */}
      <div
        className='flex flex-wrap justify-center p-16 px-5 lg:px-60'
        data-aos='fade-up'
      >
        {/* Core Plan */}
        <div className='w-full sm:w-1/2 lg:w-1/3 p-4 lg:p-12 bg-white border-2 border-neutral-300 rounded-lg shadow-lg'>
          <img
        ...
        {/* Plus Plan */}
        <div className='w-full sm:w-2/3 lg:w-1/3 p-4 lg:p-12 bg-white border-2 border-black rounded-lg shadow-lg relative'>
          {/* Most Popular Ribbon */}
      ...
      <div className='text-center mt-8' data-aos='fade-up'>
        <button
          ...
          className='px-44 py-4 border-2 border-red-900 rounded-full text-black font-bold hover:bg-black hover:text-white hover:border-red-500 transition-all duration-300 shadow-md'
        >
          GET STARTED
        </button>
      </div>
