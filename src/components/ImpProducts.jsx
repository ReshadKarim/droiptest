...
const products = [
  {
    ...
    icon: "src/assets/DriverApplication.png", // Replace this with an actual image or icon
  },
  {
...
const ImpProducts = () => {
  return (
    <div className='bg-white font-[Outfit] py-16'>
      ...
      {/* Top three products */}
      <div
        className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-20 max-w-screen-lg mx-auto px-4'
        data-aos='fade-up'
      >
