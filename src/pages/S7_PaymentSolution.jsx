    ...
    <div>
      ...
      >
        ...
        <p className='relative text-white text-xs md:text-base lg:text-lg font-normal z-10 text-center px-4'>
          At Limo Anywhere, we believe Software and Payments are better
          together. That's why we've launched Limo Anywhere Pay, to give you a
          single payment solution to solve all of your business needs.
        </p>
        <div className='mt-6'>
...
export default S7_PaymentSolution;
