...
function S5_CustomizableAddons() {
  return (
    <div>
      <Navbar />
      <div
      ...
      >
        ...
        <p className='relative text-white text-xs md:text-base lg:text-lg font-normal z-10 text-center px-4'>
          Customizable addons with competitive pricing that empower you to
          operate your business seamlessly and efficiently.
        </p>
        <div className='mt-6'>
...
export default S5_CustomizableAddons;
