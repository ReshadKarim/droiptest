    ...
    <div>
      ...
      >
        ...
        <p className='relative text-white text-xs md:text-base lg:text-lg font-normal z-10 text-center px-4'>
          Become Part Of The Largest Ground Transportation Network In The World,
          build up your presence on LA Net, and become the preferred supplier
          for other Limo Anywhere customers in your home market.
        </p>
        <div className='mt-6'>
...
export default S8_AffiliateNetwork;
