    ...
    <div>
      ...
      >
        ...
        <p className='relative text-white text-xs md:text-base lg:text-lg font-normal z-10 text-center px-4'>
          Our Passenger Web App (PWA) provides our customers an easy way to
          offer their travelers a way to book rides, manage their accounts, and
          track their in-progress rides with status updates and driver GPS
          location. All of this can be done directly on any mobile device just a
          tap away.
        </p>
        <div className='mt-6'>
...
export default S6_PassengerApp;
