    ...
    <div>
      ...
      >
        ...
        <h2 className='relative text-white text-lg md:text-2xl lg:text-3xl font-normal z-10 text-center px-4 mb-3'>
          ELIMINATE CONFUSION AND TRACK RIDE PROGRESS WITH REAL-TIME GPS
        </h2>
        <p className='relative text-white text-xs md:text-base lg:text-lg font-normal z-10 text-center px-4'>
          Manage your fleet with our industry-leading free driver app which
          allows your drivers to receive, manage, and close out their trips in
          real-time.
        </p>
        <div className='mt-6'>
...
export default S3_DriverApplication;
