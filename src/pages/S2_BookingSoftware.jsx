    ...
    <div>
      ...
      >
        ...
        <h2 className='relative text-white text-lg md:text-2xl lg:text-3xl font-normal z-10 text-center px-4 mb-3'>
          ALL THE SOFTWARE YOU NEED TO RUN YOUR LIVERY BUSINESS
        </h2>
        <p className='relative text-white text-xs md:text-base lg:text-lg font-normal z-10 text-center px-4'>
          Desktop and Mobile Booking, Scheduling, Dispatch, and Reservation
          Management. All In One. Limo Anywhere's broad set of features,
          flexibility, and accessibility make it a must-have platform for any
          livery provider to help you increase productivity and grow your
          business.
        </p>
        <div className='mt-6'>
...
export default S2_BookingSoftware;
